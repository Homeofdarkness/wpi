...
- `stats/` содержит Pydantic-модели, ограничения входных данных, pretty-вывод
  и YAML-codec промышленности. Формулы эффектов разбираются безопасным AST без
  `eval`.
...
4. Тремя месячными подшагами обновляются ресурсы и склады.
...
10. Рассчитываются вероятности крупных событий за квартал.
...
alias, имя и одну из фиксированных групп в YAML. Цель эффекта может ссылаться
