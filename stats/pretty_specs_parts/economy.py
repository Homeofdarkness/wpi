...
ECONOMY_COMMON_FIELDS = {
    "population_count": field(
        "population_count", "Население", decimals=0, aliases=("Население",)
    ),
    "decrement_coefficient": field(
        "decrement_coefficient", "УНЧС", decimals=0
    ),
    "income": field(
        "income", "Прирост", decimals=0, read_only=True, default=0
    ),
    "budget": field(
        "budget",
        "Казна",
    ...
    "med4": list_item(
        "med_wastes", "Наука", 4, decimals=1, aliases=("науку",)
    ),
    "war0": list_item(
        "war_wastes", "Траты на армию", 0, decimals=1, aliases=("Армия",)
    ),
    "war1": list_item(
        "war_wastes",
    ...
    "trade_efficiency": field(
        "trade_efficiency",
        "Эфф. торговли",
        decimals=0,
        suffix="%",
        aliases=("Эффективность торговли",),
    ),
    "trade_usage": field(
        "trade_usage",
        "Исп. пути",
    ...
    "trade_usage_load": field(
        "trade_usage_load",
        "Загрузка путей",
        decimals=0,
        suffix="%",
        read_only=True,
        getter=trade_usage_load,
        default=0.0,
    ...
    "available_trade_paths": field(
        "available_trade_paths",
        "Доступные пути",
        decimals=0,
        read_only=True,
        getter=available_trade_paths,
        default=0,
    ),
    "hq": field(
    ...
    "lq": field(
        ...
        decimals=1,
        suffix="%",
        aliases=("Низкого качества",),
    ),
    "valgery": field("valgery", "Вальжерия", decimals=1, suffix="%"),
    "allegorization": field(
        "allegorization", "Аллегоризация", decimals=1, suffix="%"
    ),
    "forex": field("forex", "Курс валюты", decimals=2, default=0.0),
    "trade_income": field(
        "trade_income", "Торговая прибыль", decimals=3, default=0.0
    ),
    "branches_count": field(
        "branches_count",
        "Филиалы",
        decimals=0,
        aliases=("Количество филиалов",),
    ),
    "branches_efficiency": field(
        "branches_efficiency", "Эффективность", decimals=1, suffix="%"
    ),
    "branches_income": field(
        "branches_income", "Доход", decimals=3, default=0.0
    ),
    "public_debt": field(
        "public_debt", "Государственный долг", decimals=2, suffix=" ед.вал"
    ),
    "annual_interest_rate": field(
        "annual_interest_rate", "Ставка долга", decimals=2, suffix="% годовых"
    ),
    "resource_balance": field(
        "resource_balance", "Баланс ресурсов", decimals=2, suffix=" ед.вал"
    ),
}
...
BASIC_ECONOMY_LAYOUT = PrettyLayoutSpec(
    fields={
        **ECONOMY_COMMON_FIELDS,
        "small_enterprise_tax": field(
            "small_enterprise_tax",
            "Нал. предпр.",
            decimals=1,
            aliases=("Налог на предпринимательство",),
        ),
        "large_enterprise_tax": field(
            "large_enterprise_tax",
            "Нал. круп. предпр.",
            decimals=1,
            aliases=("Налог на крупных предпринимателей",),
        ),
        ...
        "other0": list_item(
            "other_wastes",
            "Субсидирование бизнеса",
            0,
            decimals=1,
            aliases=("Субсидии бизнесу",),
        ),
    ...
    lines=(
        ...
        PrettyLineSpec(
            fields=("public_debt", "annual_interest_rate", "resource_balance")
        ),
        PrettyLineSpec(
            fields=("tax_income", "universal_tax", "excise"), min_gap=8
        ),
        PrettyLineSpec(
            fields=(
                "additions",
        ...
        PrettyLineSpec(
            fields=("med0", "med1", "med2"), line_width=170, min_gap=12
        ),
        PrettyLineSpec(fields=("med3", "med4"), line_width=130, min_gap=30),
        PrettyLineSpec(
            fields=("other0", "other1", "other2"), line_width=165, min_gap=12
        ),
        PrettyLineSpec(title="ВОЕННЫЕ ТРАТЫ", gap_before=1),
        PrettyLineSpec(
            fields=("war0", "war1", "war2", "other2"),
            line_width=165,
            min_gap=12,
        ),
        ...
        PrettyLineSpec(
            fields=("available_trade_paths", "trade_income"),
            line_width=130,
            min_gap=24,
        ),
        PrettyLineSpec(fields=("hq", "mq", "lq"), min_gap=10),
        PrettyLineSpec(
            fields=("valgery", "allegorization", "forex"), min_gap=10
        ),
...
ATTERIUM_ECONOMY_LAYOUT = PrettyLayoutSpec(
    fields={
        **ECONOMY_COMMON_FIELDS,
        ...
        "investment_of_large_companies": field(
            "investment_of_large_companies",
            "Вложения крупных компаний",
            decimals=1,
        ),
        "plan_efficiency": field(
            "plan_efficiency",
            "Эфисп приказов Цесаркии",
            decimals=1,
            suffix="%",
        ),
        "gov0": list_item(
        ...
        "gov1": list_item(
            "gov_wastes", "Логистика", 1, decimals=1, aliases=("логистики",)
        ),
        "gov2": list_item(
            "gov_wastes",
            "Федеративное",
        ...
        "power_of_economic_formation": field(
            "power_of_economic_formation", "Сила СЭЗ", decimals=1
        ),
    },
    lines=(
        PrettyLineSpec(title="ЭКОНОМИКА"),
        ...
        PrettyLineSpec(
            fields=("branches_count", "branches_efficiency", "branches_income")
        ),
        PrettyLineSpec(
...
ISF_ECONOMY_LAYOUT = PrettyLayoutSpec(
    fields={
        **ECONOMY_COMMON_FIELDS,
        "small_business_tax": field(
            "small_business_tax", "Налог на малый бизнес", decimals=1
        ),
        "large_enterprise_tax": field(
            "large_enterprise_tax", "Налоги с аристократии", decimals=1
        ),
        "gov0": list_item(
            "gov_wastes",
            "Инфраструктура",
    ...
    lines=(
        ...
        PrettyLineSpec(fields=("tax_income", "universal_tax", "excise")),
        PrettyLineSpec(
            fields=("additions", "small_business_tax", "large_enterprise_tax")
        ),
