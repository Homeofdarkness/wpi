...
COMMON_REGEX_PATTERNS: Dict[str, Any] = {
    'additions': 'Дополнительные средства - \\+([\\d.]+) ед\\.вал',
    'allegorization': 'Аллегоризация - ([\\d.]+)%',
    'branches_count': 'Количество филиалов - (\\d+)',
    'branches_efficiency': 'Эффективность - ([\\d.]+)%',
    'current_budget': {'type': 'budget_calculation',
                       'pattern': 'Казна- [+-]([\\d.]+) \\(([\\d.]+)\\)',
                       'field': 'current_budget'},
    'decrement_coefficient': 'УНЧС - (\\d+)', 'excise': 'Акцизы - ([\\d.]+)',
    'forex': 'Курс валюты - ([\\d.]+)',
    'high_quality_percent': 'Высокого качества - ([\\d.]+)%',
    'inflation': 'Инфляция - ([\\d.]+)%',
    'low_quality_percent': 'Низкого качества - ([\\d.]+)%',
    'med_wastes': ['Траты на образование - ([\\d.]+)',
                   'здравоохранение - ([\\d.]+)',
                   'охранные учреждения - ([\\d.]+)',
                   'соц\\.сферу - ([\\d.]+)', 'науку - ([\\d.]+)'],
    'mid_quality_percent': 'Среднего качества - ([\\d.]+)%',
    'population_count': 'Население-(\\d+)',
    'prev_budget': {'type': 'budget_calculation',
                    'pattern': 'Казна- [+-]([\\d.]+) \\(([\\d.]+)\\)',
                    'field': 'prev_budget'},
    'stability': 'Экономическая стабильность - (\\d+)%',
    'tax_income': 'ДОХОДЫ - \\+ ([\\d.]+) ед\\.вал',
    'trade_efficiency': 'Эффективность торговли - (\\d+)%',
    'trade_income': 'Торговая прибыль - ([\\d.]+)',
    'trade_rank': 'Торговый ранг - (\\d+)',
    'trade_usage': 'Число используемых торговых путей - (\\d+)',
    'trade_wastes': 'Транспортные издержки - ([\\d.]+) ед\\.вал',
    'universal_tax': 'УН - ([\\d.]+)', 'valgery': 'Вальжерия - ([\\d.]+)%',
    'war_wastes': ['Траты на армию - ([\\d.]+)',
                   'военное производство - ([\\d.]+)', 'флот - ([\\d.]+)']}
BASIC_REGEX_PATTERNS: Dict[str, Any] = {
    'small_enterprise_tax': 'Налог на предпринимательство - ([\\d.]+)',
    'large_enterprise_tax': 'Налог на крупных предпринимателей - ([\\d.]+)',
    'gov_wastes': ['Содержание инфраструктуры - ([\\d.]+)',
                   'логистики - ([\\d.]+)', 'гос\\.аппарата - ([\\d.]+)',
                   'ресурсодобычи - ([\\d.]+)'],
    'other_wastes': ['Субсидирование бизнеса - ([\\d.]+)',
                     'Внешние расходы - ([\\d.]+)', 'Оккупация - ([\\d.]+)']}
ATTERIUM_REGEX_PATTERNS: Dict[str, Any] = {
    'freedom_and_efficiency_of_small_business': 'СиРМБ - ([\\d.]+)',
    'investment_of_large_companies': 'Вложения крупных компаний - ([\\d.]+)',
    'plan_efficiency': 'Эфисп приказов Цесаркии - ([\\d.]+)%',
    'gov_wastes': ['Содержание инфраструктуры - ([\\d.]+)',
                   'логистики - ([\\d.]+)', 'федеративное - ([\\d.]+)',
                   'республиканское - ([\\d.]+)', 'ресурсодобычи - ([\\d.]+)'],
    'other_wastes': ['Внешние расходы - ([\\d.]+)', 'Оккупация - ([\\d.]+)'],
    'adrian_effect': 'Эффект Адриана \\(Рантье\\) - ([\\d.]+)',
    'power_of_economic_formation': 'Сила СЭЗ - ([\\d.]+)'}
ISF_REGEX_PATTERNS: Dict[str, Any] = {
    'small_business_tax': 'Налог на малый бизнес - ([\\d.]+)',
    'large_enterprise_tax': 'Налоги с аристократии - ([\\d.]+)',
    'gov_wastes': ['Содержание инфраструктуры - ([\\d.]+)',
                   'логистики - ([\\d.]+)', 'гос\\.аппарата - ([\\d.]+)',
                   'ресурсодобычи - ([\\d.]+)'],
    'other_wastes': ['Внешние расходы - ([\\d.]+)', 'Оккупация - ([\\d.]+)']}
