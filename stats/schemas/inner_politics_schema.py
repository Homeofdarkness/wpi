...
COMMON_REGEX_PATTERNS: Dict[str, Any] = {
    'commitment_to_cause': 'Собственная Убеждённость Делу - (\\d+)',
    'contentment': 'Довольство населения - (\\d+)',
    'corruption_level': 'Коррупция - (\\d+)',
    'cultural_level': 'Уровень культуры - (\\d+)',
    'departure_from_truths': 'Отхождение от истин - (\\d+)',
    'erudition_will': 'Стремление к эрудиции - (\\d+)',
    'government_trust': 'Доверие властям - ([\\d.]+)',
    'integrity_of_faith': 'Целостность веры - (\\d+)',
    'jobless_level': 'Процент безработицы - ([\\d.]+)',
    'many_children_propoganda': 'Пропаганда многодетности - (\\d+)',
    'many_children_traditions': 'Традиции многодетности - (\\d+)',
    'military_equipment': 'ЗВО - ([\\d.]+)',
    'panic_level': 'Паника - ([\\d.]+)%',
    'poor_level': 'Процент бедности - ([\\d.]+)',
    'provinces_count': 'Число провинций - (\\d+)',
    'provinces_waste': 'Траты на одну - ([\\d.]+) ед\\.вал',
    'salt_security': 'Солевой достаток - (\\d+)%',
    'sexual_asceticism': 'Сексуальный аскетизм - ([\\d.]+)',
    'state_apparatus_efficiency': 'Эффективность - (\\d+)%',
    'state_apparatus_size': 'Размер - (\\d+)%',
    'unemployment_rate': 'Процент тунеядства - ([\\d.]+)',
    'violence_tendency': 'Склонность к насилию - ([\\d.]+)'}
BASIC_REGEX_PATTERNS: Dict[str, Any] = {
    'knowledge_level': 'Уровень образования - ([\\d.]+)',
    'income_from_scientific': 'Доход от научных предприятий - ([\\d.]+) ед\\.вал',
    'small_enterprise_percent': 'Процент предпринимателей - ([\\d.]+)',
    'large_enterprise_count': 'Количество крупных предпринимателей - (\\d+)',
    'control': ['Правящая сила - ([\\d.]+)%', 'Представительство - ([\\d.]+)%',
                'Имеющие силу - ([\\d.]+)%', 'Автономии - ([\\d.]+)%'],
    'egocentrism_development': 'Эгоцентризм развития - ([\\d.]+)',
    'education_level': 'Образованность - ([\\d.]+)',
    'grace_of_the_highest': 'Милость Высших - (\\d+)'}
ATTERIUM_REGEX_PATTERNS: Dict[str, Any] = {
    'state_apparatus_functionality': 'Cвязь Федерации с Республиками - ([\\d.]+)%',
    'knowledge_level': 'Уровень образования - (\\d+)',
    'small_enterprise_percent': 'Малый бизнес - ([\\d.]+)',
    'large_enterprise_count': 'Клюпр Цесаркии - (\\d+)',
    'control': ['Правящая сила - ([\\d.]+)%', 'Представительство - ([\\d.]+)%',
                'Имеющие силу - ([\\d.]+)%', 'Автономии - ([\\d.]+)%'],
    'egocentrism_development': 'БТЗГ - ([\\d.]+)',
    'capitalistic_decay': 'Капиталистическое разложение - ([\\d.]+)',
    'education_level': 'Образованность - ([\\d.]+)',
    'equality': 'Равенство - ([\\d.]+)%',
    'grace_of_the_highest': 'Милость Высших - (\\d+)'}
ISF_REGEX_PATTERNS: Dict[str, Any] = {
    'knowledge_level': 'Уровень образования - (\\d+)',
    'small_enterprise_percent': 'Малый бизнес - ([\\d.]+)',
    'large_enterprise_count': 'Аристократические и коммерческие дома - (\\d+)',
    'allegory_influence': 'Влияние Аллегории - ([\\d.]+)%',
    'control': ['Императорский двор - ([\\d.]+)%',
                'Представительство - ([\\d.]+)%', 'Аристократия - ([\\d.]+)%',
                'Автономии - ([\\d.]+)%'],
    'egocentrism_development': 'Эгоцентризм развития - ([\\d.]+)',
    'education_level': 'Образованность - (\\d+)',
    'imperial_court_power': 'Сила Имперского Двора - ([\\d.]+)%',
    'grace_of_the_silver': 'Милость Серебрянной - (\\d+)',
    'separatism_of_the_highest': 'Сепаратизм Высших - (\\d+)'}
